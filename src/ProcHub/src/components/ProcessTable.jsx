        ...
        <DialogContent>
          {selectedRow && (
            <div>
              ...
              <p>
                <strong>CPU Usage:</strong> {selectedRow.cpuUsage}
              </p>
              <p>
                <strong>RAM Usage:</strong> {selectedRow.ramUsage}
              </p>
              <p>
                <strong>Uptime:</strong> {selectedRow.uptime}
              </p>
              <p>
                <strong>User:</strong> {selectedRow.user}
              </p>
              <p>
                <strong>Other info:</strong> {"blahblahblah"}
              </p>
            </div>
          )}
        </DialogContent>
